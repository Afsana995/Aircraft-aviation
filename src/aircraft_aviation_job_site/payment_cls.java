 ...
 * @author ASUS
 */
public class payment_cls extends javax.swing.JFrame {

    /** Creates new form payment_cls */
    public payment_cls() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String course_name= jTextField6.getText();
        try{
           Connection con=ConnectionProvider.getCon();
           Statement st=con.createStatement();
           st.executeUpdate("Insert into payment values('"+id+"','"+date+"','"+amount+"','"+name+"','"+contact_number+"','"+course_name+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(payment_cls.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
